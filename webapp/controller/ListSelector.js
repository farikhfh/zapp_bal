sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("ZAPP_APPR_BAL.ZAPP_APPR_BAL.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias ZAPP_APPR_BAL.ZAPP_APPR_BAL.controller.ListSelector
			 */
			 ...
			 * @return {ZAPP_APPR_BAL.ZAPP_APPR_BAL.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
