...
sap.ui.define([
	...
	"ZAPP_APPR_BAL/ZAPP_APPR_BAL/model/grouper",
	...
	return BaseController.extend("ZAPP_APPR_BAL.ZAPP_APPR_BAL.controller.Master", {
		...
		onSearch: function(oEvent) {
			...
			if (sQuery) {
				this._oListFilterState.aSearch = [new Filter("BalId", FilterOperator.Contains, sQuery)];
			} else {
		...
		onOpenViewSettings: function() {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("ZAPP_APPR_BAL.ZAPP_APPR_BAL.view.ViewSettingsDialog", this);
		...
		onConfirmViewSettingsDialog: function(oEvent) {
			...
			aFilterItems.forEach(function(oItem) {
				switch (oItem.getKey()) {
					case "DRAFT":
						aFilters.push(new Filter("Status", FilterOperator.Contains, "DRAFT"));
						break;
					case "RELEASE":
						aFilters.push(new Filter("Status", FilterOperator.Contains, "RELEASE"));
						break;
					case "PROCESSED":
						aFilters.push(new Filter("Status", FilterOperator.Contains, "PROCESSED"));
						break;
					case "REJECT":
						aFilters.push(new Filter("Status", FilterOperator.Contains, "REJECT"));
						break;
					default:
						break;
				}
		...
		_onMasterMatched: function() {
			this.getOwnerComponent().oListSelector.oWhenListLoadingIsDone.then(
				function(mParams) {
					...
					var sObjectId = mParams.firstListitem.getBindingContext().getProperty("BalId");
		...
		_showDetail: function(oItem) {
			...
			this.getRouter().navTo("object", {
				objectId: oItem.getBindingContext().getProperty("BalId")
			}, bReplace);
		},
