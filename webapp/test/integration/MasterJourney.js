...
sap.ui.define([
	...
	opaTest("MasterList Filtering on Amt less than 100", function(Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
			and.iSelectListItemInViewSettingsDialog("<Amt>").
	...
	opaTest("MasterList Filtering on Amt more than 100", function(Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
			and.iSelectListItemInViewSettingsDialog(">100 <Waers>").
			and.iPressOKInViewSelectionDialog();
