sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("ZAPP_APPR_BAL/ZAPP_APPR_BAL/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#ApporvalandMonitoringBAL-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#ApporvalandMonitoringBAL-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("ZAPP_APPR_BAL.ZAPP_APPR_BAL.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["ZAPP_APPR_BAL/ZAPP_APPR_BAL/localService/mockserver"], function (mockserver) {
